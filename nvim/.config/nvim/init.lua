...
TODO: After understanding a bit more about Lua, you can use `:help lua-guide` as a
...
-- Moving lines in the visual mode
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>st', builtin.live_grep, { desc = '[S]earch for [T]ext' })
